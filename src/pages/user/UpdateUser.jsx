    ...
    useEffect(() => {
      if (currentUser && Object.keys(currentUser).length > 0) {
        reset({
          ...
          partnerId: currentUser.partner?.id ?? currentUser.partnerId ?? "",
          roleName: currentUser.role?.name ?? currentUser.roleName ?? "",
          zoneId: currentUser.zone?.id ?? currentUser.zoneId ?? "",
          agenceId: currentUser.agence?.id ?? currentUser.agenceId ?? "",
        });
      }
    }, [currentUser, reset]);
    ...
    return (
        ...
        <div className="p-5">
            ...
            <p className="text-sm text-slate-700 mb-6">
                Entrer les informations pour la modification d'un utilisateur
            </p>
